...
class ActionRequiredResponse(BaseModel):
    action_type: str = Field(
        ...,
        description="Action type for frontend routing: 'password_reset' or 'email_verification'",
    )
    token: str | None = Field(default=None, description="Token for the password reset")
