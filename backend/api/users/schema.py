...
class UserResponse(BaseModel):
    ...
    role_level: int | None = Field(None, description="Privilege level of the user's primary role")
...
class UserCreate(BaseModel):
    ...
    password: str = Field(
        ..., min_length=settings.PASSWORD_MIN_LENGTH, max_length=50, description="Password"
    )
...
class UserUpdate(BaseModel):
    ...
    status: bool | None = Field(None, description="User status")
    role: str | None = Field(None, description="User role")
...
user_delete_partial_response_example = {
    ...
    "data": {
        "results": [
            ...
            {"user_id": "uuid-user-id-2", "status": "failed", "message": "User not found"},
        ],
        "total_users": 2,
        "success_count": 1,
        "failed_count": 1,
...
user_delete_failed_response_example = {
    ...
    "data": {
        "results": [{"user_id": "uuid-user-id-1", "status": "failed", "message": "User not found"}],
        "total_users": 1,
        "success_count": 0,
        "failed_count": 1,
    },
