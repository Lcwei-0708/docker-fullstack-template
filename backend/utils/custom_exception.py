...
class ServerException(BaseServiceException):
    ...
    def __init__(
        self, message: str = "Server error", status_code: int = 500, details: dict[str, Any] = None
    ):
        super().__init__(
            message=message,
...
class PasswordResetRequiredException(BaseServiceException):
    ...
    def __init__(self, message: str = "Password reset required", details: dict[str, Any] = None):
        super().__init__(
            message=message, error_code="PASSWORD_RESET_REQUIRED", details=details, status_code=202
        )
...
class EmailVerificationRequiredException(BaseServiceException):
    ...
    def __init__(
        self, message: str = "Email verification required", details: dict[str, Any] = None
    ):
        super().__init__(
            message=message,
