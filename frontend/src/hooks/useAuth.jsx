...
import { getApiErrorMessage, isCsrfInvalidError, isSessionInvalidError } from "@/lib/authErrors";
...
export const useAuth = () => {
  ...
  const getToken = useCallback(
    async (isInit = false, _skipProfile = false) => {
  ...
  const updateUserProfile = useCallback(
    async (userData, config = {}) => {
      try {
        ...
        const result = await accountService.updateProfile(userData, {
          ...restConfig,
          returnStatus,
        });
