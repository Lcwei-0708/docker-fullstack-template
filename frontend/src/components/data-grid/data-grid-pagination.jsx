      ...
      return (
        <PaginationItem key={page}>
          <PaginationLink
            ...
            className={cn(
              "h-8 w-8 p-0 text-sm rounded-xs",
              pageIndex === pageIndexValue ? "" : "text-muted-foreground"
            )}
          >
            {page}
          </PaginationLink>
          ...
          <>
            {recordCount !== undefined && recordCount !== null && (
              <div className="text-sm text-muted-foreground">
                {t("components.pagination.totalAccounts", "Total {{count}} accounts", {
            ...
            >
              <SelectTrigger className="w-fit font-normal" size="default">
