  ...
  return React.useMemo(() => {
    ...
    if (enableSelection && canManageUsers) {
      baseColumns.push({
        ...
        cell: ({ row }) => (
          <DataGridTableRowSelect row={row} size="sm" className="justify-center" />
        ),
        enableSorting: false,
      ...
      },
      {
        ...
        header: ({ column }) => {
          const statusFilterOptions = column.columnDef.meta?.filterOptions || [
            {
              value: "true",
              label: t("pages.usersManagement.fields.status.values.active", "Active"),
            },
            {
              value: "false",
              label: t("pages.usersManagement.fields.status.values.inactive", "Inactive"),
            },
          ];
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center justify-center">
              <DropdownMenu>
                <DropdownMenuTrigger asChild className="shrink-0 justify-center">
