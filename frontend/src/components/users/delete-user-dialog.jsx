      ...
      <AlertDialogContent>
        ...
        {includesCurrentUser && (
          <Alert variant="warning" appearance="light" size="md">
            ...
            <AlertDescription>{alertWarningMessage}</AlertDescription>
          </Alert>
        )}
        <AlertDialogFooter>
          {!isMultiple && includesCurrentUser ? (
            <AlertDialogAction onClick={() => onOpenChange(false)} variant="default">
            ...
            <>
              ...
              <AlertDialogAction
                ...
                variant="destructive"
              >
                {isDeleting ? <Spinner className="size-4" /> : t("common.actions.delete", "Delete")}
              </AlertDialogAction>
            </>
          )}
        </AlertDialogFooter>
