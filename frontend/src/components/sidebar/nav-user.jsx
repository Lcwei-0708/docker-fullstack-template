...
import { LogOut, Languages, Moon, Sun, Check, CircleUser, EllipsisVertical } from "lucide-react";
        ...
        <SidebarMenuItem>
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem
                className="cursor-pointer py-2 text-destructive hover:!text-destructive hover:!bg-destructive/10"
