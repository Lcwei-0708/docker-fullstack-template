...
export function Icon({
  ...
  const fillColor = fill !== undefined ? fill : isActive ? "var(--primary)" : "currentColor";
  ...
  }, [iconContent, fillColor, hasExplicitFill, stroke, strokeWidth, size, className, hasSizeClass]);
  ...
  return (
    <span
      className={cn("inline-block", "bg-current", sizeClassName, className)}
      style={{
        ...sizeClasses,
