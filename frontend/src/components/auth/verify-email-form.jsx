  ...
  useEffect(() => {
    if (!token) {
      ...
      if (stateEmail) {
        ...
        setErrorMessage(
          t("pages.auth.verifyEmail.messages.noToken", {
            defaultValue: "No verification token provided",
          })
        );
      }
      ...
      <div className={cn("space-y-6", className)}>
        <div className="text-center">
          <p className="text-muted-foreground text-sm">
            {t("pages.auth.verifyEmail.messages.success", {
  ...
  if (verificationStatus === "pending" && email) {
    return (
      <div className={cn("space-y-6", className)}>
        <div className="text-center">
          <p className="text-muted-foreground text-sm">
            {t("pages.auth.verifyEmail.messages.pending", {
              defaultValue:
        ...
        <div className="space-y-4">
          ...
          >
            {isResending ? (
              ...
              <>
                <Mail className="w-4 h-4" />
                {t("pages.auth.verifyEmail.actions.resend", {
