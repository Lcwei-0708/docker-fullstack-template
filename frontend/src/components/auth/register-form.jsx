    ...
    >
      <span className="inline-flex items-center justify-center gap-2 min-w-[120px]">
        {isSubmitting ? (
          ...
          t("pages.auth.register.actions.submit", { defaultValue: "Sign up" })
        )}
      </span>
    </Button>
  );
    ...
    return z
      .object({
        first_name: z.string().min(
          1,
          t("pages.auth.register.fields.firstName.validation.required", {
            defaultValue: "Please enter your first name",
          })
        ),
        last_name: z.string().min(
          1,
          t("pages.auth.register.fields.lastName.validation.required", {
        ...
        email: z
          ...
          .min(
            1,
            t("pages.auth.register.fields.email.validation.required", {
          ...
          .refine(
            ...
            {
              message: t("pages.auth.register.fields.email.validation.invalid", {
        ...
        phone: z.string().min(
          1,
          t("pages.auth.register.fields.phone.validation.required", {
        ...
        password: z
          ...
          .min(
            1,
            t("pages.auth.register.fields.password.validation.required", {
              defaultValue: "Please enter your password",
            })
          )
          .min(
            6,
            t("pages.auth.register.fields.password.validation.minLength", {
              defaultValue: "Password must be at least 6 characters",
            })
          ),
        confirm_password: z.string().min(
          1,
          t("pages.auth.register.fields.confirmPassword.validation.required", {
            defaultValue: "Please confirm your password",
          })
        ),
      })
      .refine((data) => data.password === data.confirm_password, {
        message: t("pages.auth.register.fields.confirmPassword.validation.notMatch", {
      ...
      <form className={cn("space-y-6", className)} onKeyDown={handleKeyDown} {...props}>
        <div className="grid grid-cols-2 gap-4 items-start">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t("pages.auth.register.fields.firstName.label", { defaultValue: "First Name" })}
                </FormLabel>
                <FormControl>
                  <Input
                    type="text"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t("pages.auth.register.fields.lastName.label", { defaultValue: "Last Name" })}
                </FormLabel>
                <FormControl>
                  <Input type="text" placeholder="" {...field} disabled={isSubmitting} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {t("pages.auth.register.fields.email.label", { defaultValue: "Email" })}
              </FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {t("pages.auth.register.fields.phone.label", { defaultValue: "Phone" })}
              </FormLabel>
              <FormControl>
                <Input type="tel" placeholder="" {...field} disabled={isSubmitting} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="grid grid-cols-2 gap-4 items-start">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t("pages.auth.register.fields.password.label", { defaultValue: "Password" })}
                </FormLabel>
                <FormControl>
                  <Input
                    type="password"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t("pages.auth.register.fields.confirmPassword.label", {
        ...
        <div className="text-center text-sm flex items-center justify-center gap-2">
          <span className="text-muted-foreground">
            {t("pages.auth.register.links.existingUser", {
