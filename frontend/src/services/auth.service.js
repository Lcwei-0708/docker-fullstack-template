...
export const authService = {
    ...
    apiService.post(
      ...
      { new_password: newPassword },
      {
        ...
        messageMap: {
          ...
          401: i18n.t(
            "pages.auth.resetPassword.messages.invalidToken",
  ...
  validateResetToken: (resetToken, config = {}) =>
    apiService.get(
      `${BASE_AUTH}/validate-reset-token`,
      {},
      {
        headers: { Authorization: `Bearer ${resetToken}` },
        noToken: true,
  ...
  forgotPassword: (email, config = {}) =>
    apiService.post(
      ...
      { email },
      {
        ...
        messageMap: {
          success: i18n.t(
            "pages.auth.forgotPassword.messages.success",
            "Password reset email sent"
          ),
          400: i18n.t(
            "pages.auth.forgotPassword.messages.cooldown",
          ...
          404: i18n.t(
            "pages.auth.forgotPassword.messages.emailNotRegistered",
  ...
  getPasswordResetCooldown: (email, config = {}) =>
    apiService.get(
      `${BASE_AUTH}/forgot-password/cooldown`,
      { email },
      {
        noToken: true,
        retryOn401: false,
    ...
    apiService.get(
      ...
      {},
      {
        ...
        messageMap: {
          ...
          401: i18n.t(
            "pages.auth.verifyEmail.messages.invalidToken",
    ...
    apiService.post(
      ...
      { email },
      {
        ...
        messageMap: {
          ...
          400: i18n.t(
            "pages.auth.verifyEmail.messages.cooldown",
            "Please wait before requesting another verification email"
          ),
          403: i18n.t("pages.auth.verifyEmail.messages.accountDisabled", "Account is disabled"),
          404: i18n.t(
            "pages.auth.verifyEmail.messages.emailNotRegistered",
            "This email is not registered"
          ),
  ...
  getEmailVerificationCooldown: (email, config = {}) =>
    apiService.get(
      `${BASE_AUTH}/resend-verification/cooldown`,
      { email },
      {
        noToken: true,
        retryOn401: false,
